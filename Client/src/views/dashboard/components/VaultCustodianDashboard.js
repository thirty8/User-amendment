...
import VaultCustodianCases from "../../screens/cases"; // Import the appropriate screen/component

const VaultCustodianDashboard = () => {
 ...
 useEffect(() => {
  ...
  // ... Other state and hooks for the dashboard ...
  ...
  return (
    <>
      {/* Conditional rendering for the case screen */}
      {showScreen && (
        <div
      ...
      <div className="flex flex-col items-center p-4 -mt-5">
        ...
        <div className="flex justify-between space-x-4 mb-4 w-full">
          <Card
            title="Total Assets in Vault"
            icon="💰"
            value={120}
            color="#BEE3F8" // Light blue shade
          />
          <Card
            title="Verified Assets"
            icon="✅"
            value={90}
            color="#CFF5D2" // Light green shade
          />
          <Card
            title="Pending Verification"
            icon="⌛"
            value={30}
            color="#FFF3C2" // Light yellow shade
          />
          <Card
            title="Rejected Assets"
            icon="❌"
            value={10}
            color="#FDC7C6" // Light red shade
          />
          <Card
            title="Average Asset Value"
            icon="💵"
            value={1800}
            color="#DFB2F4" // Light purple shade
          />
          <Card
            title="Asset Compliance Rate"
            icon="📈"
            value="85%"
            color="#F9D9B6" // Light orange shade
          />
          <Card
            title="Vault Custodian's Tasks"
            icon="🏦"
            value={45}
            color="#C6E0B4" // Light greenish shade
          />
        </div>

        {/* Charts */}
        <div className="flex w-full space-x-4">
          <ChartCard title="Assets by Category" width={25}>
            <Bar
              data={barChartData}
              options={{ maintainAspectRatio: false, height: 400 }}
            />
          </ChartCard>
          <ChartCard title="Verification Status" width={25}>
            <Pie
              data={pieChartData}
              options={{ maintainAspectRatio: false, height: 400 }}
            />
          </ChartCard>
          <ChartCard title="Asset Priority" width={25}>
            <Doughnut
              data={doughnutChartData}
              options={{ maintainAspectRatio: false, height: 400 }}
            />
          </ChartCard>
          <ChartCard title="Asset Categories" width={25}>
            <PolarArea
...
export default VaultCustodianDashboard;
