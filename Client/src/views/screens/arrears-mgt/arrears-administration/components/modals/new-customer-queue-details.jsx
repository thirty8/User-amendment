...
import AssignCollector from "./assignCollector";

function NewCustomerQueueDetails({ customerDetails, onclose, isSupervisor }) {
  // collector details
  ...
  const [assignCollectorModal, setAssignCollectorModal] = useState(false);

  console.log(customerDetails, "CUSTOMER DETAILS SELECTED");
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then(function (response) {
        console.log(response?.data, "Customer Feedback Table");
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ zoom: 0.85, color: "rgb(92, 92, 92)" }}
      >
        <div className="flex">
          <div className="mr-5">
        ...
        <div className="flex flex-col space-y-3 mt-10">
          ...
          <div className="flex">
            ...
            <div>
              {customerDetails?.days_in_arr || customerDetails?.overdue_day}
            </div>
          </div>
      ...
      <div className="flex gap-5 p-5 justify-between" style={{ zoom: 0.85 }}>
      ...
      >
        <div
          style={{
            zoom: 0.9,
            display: assignCollectorModal ? "none" : "block",
          }}
        >
      ...
      <Modal
        size={"50%"}
        opened={assignCollectorModal}
        padding={"10px"}
        withCloseButton={false}
        onClose={() => {
          setAssignCollectorModal(false);
          setShowBalScreen(true);
        }}
        centered
        scrollAreaComponent={ScrollArea.Autosize}
      >
        <div style={{ zoom: 0.9 }} className="space-y-4">
          <Header
          ...
          <AssignCollector onClose={() => setAssignCollectorModal(false)} />
        </div>
      </Modal>
    </div>
  );
...
export default NewCustomerQueueDetails;
