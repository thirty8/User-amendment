  ...
  async function handleFind(e) {
    ...
    try {
      const response = await axios.post(
        API_SERVER + "/api/get-account-details-by-account-name-or-account-desc",
        {
          currency: currency,
                        ...
                        return (
                          ...
                          >
                            <td className="capitalize px-2 py-1">
                              {i.account_descrption}
                            </td>
                            <td className="    px-2 py-1">{i.tacct}</td>
                            <td className="    px-2 py-1 text-right">
                              {i.acct_balance === "null"
                                ? "0.00"
                                : formatNumber(i.acct_balance)}
                            </td>
                            <td className="    px-2 py-1">{i.status_desc}</td>
