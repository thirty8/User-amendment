...
const GlobalBudgetEnquiry = () => {
  ...
  async function getBudgetGLsDetails(code, flag) {
    try {
      //   setloading(true);
      await axios
        .post(
        ...
        .then((res) => {
          ...
          if (res.data.length > 0) {
            ...
            res.data.map((i) => {
              ...
              totalObj.Total += NumberWithoutCommas(i.year_total);
              // setBudgetTotals((prev) => {});
              // setBudgetTotals((prev) => Object.keys(budgetTotals).map((i)=>{
              //   return {}
              // }));
            });
              ...
              arr.push([
                ...
                <div className="flex justify-center items-center">
                  <ButtonComponent
                    ...
                    buttonHeight={"25px"}
                    onClick={() => {
                      getBudgetGLsDetails(i.budget_code, budFlag);
                      //   setApprovalModal(true);
  ...
  return (
    <div>
      ...
      <div>
        <div className="mb-1">
          <Header title={"Global Budget Enquiry"} headerShade={true} />
        </div>
        <CustomTable
...
export default GlobalBudgetEnquiry;
