...
import ApprovalAmendedModal from "./components/approvalAmendedModal";
...
const ApproveAmendedBudget = () => {
  ...
  return (
    <div>
      ...
      <div>
        <div className="mb-1">
          <Header title={"Amended Budgets"} headerShade={true} />
        </div>
        <CustomTable
...
export default ApproveAmendedBudget;
