...
function GlMappingAmendment({allData,setGlMappingDetails}) {
...
useEffect(()=>{
  if(allData){
    setAssetAccount(allData.assetAccount)
    setCreditAccount(allData.creditAccount)
    setDepAccount(allData.depAccount)
    setAccumulatedDepAccount(allData.accumulatedDepAccount)
    setMaintenanceAccount(allData.maintenanceAccount)
    setDisposalAccount(allData.disposalAccount)
    setRevaluationSurplus(allData.revaluationSurplus)
    setLossOfRevaluation(allData.lossOfRevaluation)
    setWorkInProgressAccount(allData.workInProgressAccount)
...
export default GlMappingAmendment;