...
function GlAccountEnquiryGlobal() {
  ...
  const getBranch = () => {
    let branchLOVS=[]
    axios.get(API_SERVER + '/api/gl-branch',
    {headers})
    .then((response) => {
        ...
        <br/>
          <div>
            ...
            <div
                ...
                >
                  <div style={{display:"flex",flex:0.31,gap:"10px"}}>
                  <InputField
            ...
            <CustomTable headers={["Value Date","Post Date","Transaction Details","Debit","Credit","Balance","Branch","Posted By","Batch No.","Action"]} data={data} rowsPerPage={12}/>
          </div>
        </div>
        <Modal
        size="95%"
...
export default GlAccountEnquiryGlobal;
