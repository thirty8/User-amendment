    ...
    <div style={{ padding: "0px 15px" }}>
      ...
      <Modal size="85%" opened={GLamendment} withCloseButton={false} trapFocus={false}>
        ...
        >
          ...
          <GlApproveAccountModal details={details} closeGLamendment={closeGLamendment} getGlApproval={getGlApproval}/>
        </div>
...
export default GlApproveAccount;
