...
function BalanceSheetBreakdown({
  ...
  async function fetchDetails() {
    console.log(currency, formatDate(reportDate), "yeloowwwww");
    axios
      .post(
        API_SERVER + "/api/get-year-on-year-BS-breakdown-translated",
        {
          // currencyCode : "010",
          // balanceAsAt : "4-MAY-2023"
      ...
      .then((response) => {
        console.log(response, "yellowww");
        if (response.data.length > 0) {
          setDetails(response.data);
          console.log(response.data, "mmmmmmmmkkkkkkkkkkk");
