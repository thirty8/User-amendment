...
function CheckAccountBalances({ dataProcessingInfo, tableCellFontSize }) {
  ...
  let data = [ 
        ["004001100000020135", "ABDUL UNION15831", "HEAD OFFICE", "100.00", "235.00" ], 
        ["004001100000020135", "ABDUL UNION15831", "HEAD OFFICE", "100.00", "235.00" ], 
        ["004001100000020135", "ABDUL UNION15831", "HEAD OFFICE", "100.00", "235.00" ], 
        ["004001100000020135", "ABDUL UNION15831", "HEAD OFFICE", "100.00", "235.00" ], 
        ["004001100000020135", "ABDUL UNION15831", "HEAD OFFICE", "100.00", "235.00" ], 
  ...
  return (
    ...
    <div className="" style={{ zoom: "0.85", marginTop: "-5px", marginBottom: "5px" }}>

      <ThemeProvider theme={getMuiTheme()}>
        <MUIDataTable
            title={<b style={{ fontSize: "20px", fontFamily: "calibri", textTransform: "uppercase" }}>Account Balance Details</b>}
            data={data}
            columns={columns}
            options={options}
        />
