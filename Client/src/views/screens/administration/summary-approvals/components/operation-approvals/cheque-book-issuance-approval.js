...
function ChequeBookIssuanceApproval({ batchNo, setShowModal, accountNumber }) {
  ...
  useEffect(() => {
    async function fetchData() {
      return await axios.post(
        API_SERVER + "/api/cheque-book-issuance-approval",
        {
          fetch_data: "true",
...
export default ChequeBookIssuanceApproval;
