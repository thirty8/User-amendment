...
import ViewVourcherComponent from '../../../../../components/ViewVourcher';

function ViewVourcher({ setShowViewVourcherModal, docCode }) {

    // alert(docCode);

    const handleClose = () => setShowViewVourcherModal(false);
  ...
  return (
    ...
    <div>
      ...
      >
        <div className=" flex justify-between py-[6px] px-2 items-center ">
          ...
          <svg
            onClick={() => setShowViewVourcherModal(false)}
    ...
    <div className="bg-gray-200 rounded-b ">
      <div className="bg-white shadow rounded px-0 pt-1 pb-8 " style={{ marginBottom: "-25px" }}>
              ...
              <ViewVourcherComponent docCode={docCode} />
