...
function PrepaymentScheduleApproval({ batchNo, setShowModal }) {
    ...
    async function fetchApprovalDetails() {
      try {
        ...
        let response = await axios.post(
          API_SERVER + "/api/get-prepayment_manual_approval_details",
          { paymentID: batchNo },
          { headers }
        );
...
export default PrepaymentScheduleApproval;
