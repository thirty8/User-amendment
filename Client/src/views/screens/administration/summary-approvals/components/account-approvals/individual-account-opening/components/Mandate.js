...
const Mandate = ({ acMandate, handleAccountMandate, arrayDocs, relationData, ImageVerification, randomNumberString, dataD, custType, storedFormData, handleChangeDocs}) => {
