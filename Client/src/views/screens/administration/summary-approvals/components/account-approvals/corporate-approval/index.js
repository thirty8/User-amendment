...
function ApprovalScreenIndividual({ batchNo, accountSourceBranch, setCloseModal, setApproveChanged, setApproved, accountTypes, setAccountTypes }) {
  ...
  useEffect(() => {
    const fetchDataCustomerNumber = async () => {
      try {
        ...
        console.log("test_1", response.data)
    ...
    console.log("batchNo batchNo======:", batchNo);
