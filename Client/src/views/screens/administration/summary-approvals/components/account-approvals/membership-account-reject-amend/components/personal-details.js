                    ...
                    {genderOptions.map((option) => (
                      <label key={option.value} className="inline-flex items-center mr-4">
                        <input
                          ...
                          name="P_gender"
                          // value={option.value}
                          value={dataApproval.relationData && dataApproval.relationData.length > 0 ? dataApproval.relationData[0].SUFFIX : ''}
                  ...
                  <label key={option.value} className="inline-flex items-center mr-4">
                    <input
                      ...
                      value={
                       ...
                       checked={dataApproval?.relationData?.length > 0 && selectedData?.STAFF_ID === option.value}
