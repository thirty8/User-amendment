...
function ApprovalScreenIndividual({ batchNo, accountSourceBranch, setCloseModal, handleClose, setApproveChanged, setApproved, accountTypes, setAccountTypes }) {
  ...
  console.log(ctype,"dataApproval dataApproval======:", dataApproval);
...
export default ApprovalScreenIndividual;
