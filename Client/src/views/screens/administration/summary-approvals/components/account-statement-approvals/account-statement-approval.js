...
const AccountRequestApproval = ({ batch_number }) => {
  ...
  useEffect(() => {
    const fetchReportDetails = async () => {
      await axios
        ...
        .catch((err) =>
          console.error("error fetching report details and error is:" + err)
        );
    };
  ...
  useEffect(() => {
    setTotalCharge((prev) => ({
      ...prev,
      totalCharge: formatNumber(
        parseInt(totalPages?.page_no) * totalCharge?.totalCharges
      ),
    }));
  }, [accountDetails]);
                ...
                <div className="flex space-x-2">
                  <div className="w-[50%] capitalize">
                    <InputField
                      ...
                      value={
                        allDetails &&
                        allDetails?.prod_code &&
                        allDetails?.product_desc
                  ...
                  <div className="w-[50%] capitalize">
                    <InputField
                      ...
                      disabled={true}
                      value={
                        allDetails ? formatDate(allDetails?.date_opened) : ""
                      }
                      textAlign={"center"}
                    />
                  </div>
                ...
                <div className="flex space-x-2">
                  <div className="w-[50%] capitalize">
                    <InputField
                      ...
                      value={
                        allDetails &&
                        allDetails.currency_desc &&
                        allDetails.currency_code
                  ...
                  <div className="w-[50%] capitalize">
                    <InputField
                      ...
                      value={
                        allDetails
                          ? formatDate(allDetails?.date_of_last_activity)
                          : ""
                      }
                      textAlign={"center"}
                    />
                ...
                <div className="flex space-x-2 items-center">
                  <div className="w-[50%] capitalize">
                    <InputField
                      ...
                      value={
                        allDetails &&
                        allDetails.statement_type &&
                        allDetails.statement_type_desc
                ...
                <div className=" mt-[30px]">
                  ...
                  <span className="capitalize flex justify-center mt-2">
                    <InputField
                      ...
                      value={
                        totalCharge
                          ? formatNumber(totalCharge?.totalCharges)
                          : ""
                      }
                      textAlign={"center"}
                    />
