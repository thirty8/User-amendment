...
const Denominations = ({
  ...
  useEffect(() => {
    const enters = { ...entered };

    Object.keys(enters)?.forEach((i) => {
      if (enters[i]?.amount !== undefined) {
        enters[i].amount = parseFloat(enters[i].amount);
      }
    });
    console.log({ enters });
  ...
  function handleTotal() {
    ...
    Object.keys(entered).map((i) => {
      ...
      if (entered[i]?.amount === "" || entered[i]?.amount === null) {
        ...
        totalx = totalx + parseFloat(entered[i]?.amount);
      }
    });

    console.log({ totalx });
    if (parseFloat(totalx) || totalx === 0) {
      setTotal(totalx);
    }
  }
      ...
      <div className="pb-2" style={{ zoom: "85%" }}>
        ...
        <div style={{ background: "whitesmoke" }}>
          <div className=" bg-white px-2 ">
            ...
            <table className="w-full h-[400px] overflow-scroll mt-3 bg-white rounded-sm table-auto  border border-slate-300">
              <tbody>
                <tr
                              ...
                              setEntered((prev) => ({
                                ...
                                [i[0]]: {
                                  ...
                                  quantity: parseFloat(
                                    ...
                                    ? (entered[fieldName]?.amount / i[0]) * 10
                                    : "",
                                  currency_code: currency_code,
                                },
                              }));
            ...
            {entered && (
              <div className="flex justify-end mt-2">
                <ButtonComponent
                  label={okayBtn ? okayBtn?.label : "Ok"}
