...
function Permanent_Address({data, validationRules,activeStep, formValues, setFormValues, formErrors, setFormErrors, handleClose, handleShow, show_Second}) {
       ...
       <div className="flex items-center justify-center space-x-20">
        ...
        <div className="flex items-center justify-center space-x-20 -mt-3">
            ...
            <div class="w-full max-w-xl mt-2">
              ...
              <div class="md:w-1/3">
                  <Label label="Resident" required={true} />
                </div>
...
export default Permanent_Address;