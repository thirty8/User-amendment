...
function Next_Kin_tab({nextOfKingData, tableDataNok, handleClearTable, handleChangeNextOfKin, handleSubmitNextOfKin}) {
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div className="md:w-2/4 ">
                  <ListOfValue 
                    ...
                    onChange={(value) => handleChangeNextOfKin('p_next_of_kin_relationship', value)}
                  />
                </div>
              </div>
            </div>
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div className="md:w-2/4 ">
                  <ListOfValue
                    ...
                    onChange={(value) => handleChangeNextOfKin('p_next_of_kin_id_type', value)}
                  />
                </div>
              </div>
            </div>
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div class="md:w-2/3 md:ml-[2px] ">
                  <InputField 
                    ...
                    onChange={(e) => handleChangeNextOfKin('p_next_of_kin_id_no', e.target.value)}
                  />
                </div>
              </div>
            </div>
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div class="md:w-2/3 md:ml-[2px] ">
                  <InputField 
                    ...
                    onChange={(e) => handleChangeNextOfKin('p_next_of_kin_id_expdate', e.target.value)}
                  />
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div class="md:w-2/3 md:ml-[2px] ">
                  <InputField 
                    ...
                    onChange={(e) => handleChangeNextOfKin('p_next_of_kin_address', e.target.value)}
                  />
                </div>
              </div>
            </div>
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div class="md:w-2/3 md:ml-[2px] ">
                  <InputField 
                    ...
                    onChange={(e) => handleChangeNextOfKin('p_next_of_kin_dob', e.target.value)}
                  />
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div class="md:w-2/3 md:ml-[2px] ">
                  <InputField 
                    ...
                    onChange={(e) => handleChangeNextOfKin('p_next_of_kin_percentshare', e.target.value)}
                  />
                </div>
              </div>
            </div>
