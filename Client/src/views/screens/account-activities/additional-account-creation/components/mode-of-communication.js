...
function Mode_Of_Communication({data, validationRules,activeStep, formValues, setFormValues, formErrors, setFormErrors, handleClose, handleShow, 
  show_Second,
  formData,
  setFormData,
  handleChange
    ...
    <div>
                ...
                {OfficePhoneType.map((option) => (
                  <label key={option.value} className="inline-flex items-center mr-4">
                    <input
                      ...
                      onChange={() => handleChange('P_office_phone_type', option.value)}
                    />{' '}&nbsp;
                    {option.label}
                  </label>
                ))}
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div class="md:w-2/3 md:ml-[2px] ">
                  <InputField 
                    ...
                    onChange={(e) => handleChange('P_office_phone_no', e.target.value)}
                  />
                </div>
              </div>
            </div>  
                ...
                {EnableSMS.map((option) => (
                  <label key={option.value} className="inline-flex items-center mr-4">
                    <input
                      ...
                      onChange={() => handleChange('P_enable_smsalert', option.value)}
                    />{' '}&nbsp;
                    {option.label}
                  </label>
                ))}
                ...
                {EnableEmailAlert.map((option) => (
                  <label key={option.value} className="inline-flex items-center mr-4">
                    <input
                      ...
                      onChange={() => handleChange('P_enable_emailalert', option.value)}
                    />{' '}&nbsp;
                    {option.label}
                  </label>
                ))}
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                ...
                <div class="md:w-2/3 ">
                  <InputField 
                    ...
                    onChange={(e) => handleChange('P_mobile_bankphoneno', e.target.value)}
                  />
                </div>
              </div>
            </div> 
        ...
        <div className="flex items-center justify-center space-x-20 -mt-3">
            ...
            <div class="w-full max-w-xl mt-2">
              <div class="md:flex md:items-center mb-2 ml-2">
                <div class="md:w-1/3 text-right">
                  <Label label="Mobile Bank Email " required={true} fontSize="85%" />
                </div>
                <div class="md:w-2/3 md:ml-[2px] ">
                  <InputField 
                    inputWidth="300px"
                    ...
                    onChange={(e) => handleChange('P_Mobile_bankemail', e.target.value)}
                  />
                </div>
              </div>
            </div>
