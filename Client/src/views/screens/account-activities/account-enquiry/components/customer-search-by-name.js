...
import {BiCheckbox,BiSearchAlt} from "react-icons/bi";
...
import DataTable from "../../../../screens/teller-ops/components/CustomTable";
// import InputField from "../../../../../components/others/Fields/InputField";
import { Modal, Group, Button } from "@mantine/core";

import ImageVerification from "../../../../../components/others/ImageVerification";

import IndividualRelationshipAmendment from "../components/customer-search-modals/individual-relationship-amendment";
import CustomerEnquiry from "../components/customer-search-modals/customer-enquiry";
...
// import Phone_number from "../../../teller-ops/components/Phone_number";
...
function CustomerSearchByName({
      ...
      const getBranch = () => {
        axios
          ...
          .then((response) => {
            ...
            results.map((i)=>{curr.push({label: i.br_code + " - " + i.br_description, value: i.br_code})})
  ...
  return (
    ...
    <div className="bg-gray-200 rounded-b ">
      ...
      <Modal
        size="80%"
        opened={customerEnquiry}
        onClose={closeCustomerEnquiry}
...
export default CustomerSearchByName;
