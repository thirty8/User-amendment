...
function BranchBatchTransaction({bbg}) {
...
const getBranchTransactionAnalyzer = () => {
    //  console.log(formatDate(postingDate),"thaoo")
      let array = [];
      axios.post(API_SERVER + '/api/getBranchBatchTransactions',
      {
...
export default BranchBatchTransaction;
