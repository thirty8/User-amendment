...
import AccountBlockageList from "./account-balance-enquiry-modals/account-blockage-list";
...
function Customer360Enquiries({
  ...
  const tabsData = [
    { value: 'default', label: 'ACCOUNT ENQUIRY',component:<AccountBalanceEnquiry setMatrixState={setMatrixState}/> },
    { value: 'tab-2', label: 'MEMBER ENQUIRY',component:<AccountListEnquiry matrix={matrix}/>},
  ];
...
export default Customer360Enquiries;
