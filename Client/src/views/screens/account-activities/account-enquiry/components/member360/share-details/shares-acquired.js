...
import BalanceAccountDetails from "../../account-balance-enquiry-modals/balance-account-details";
  ...
  return (
    ...
    <InputField
     ...
     <InputField
                  ...
                  />
      <InputField 
                    label={"Fair Market Value On Date Of Gift :"}
                    labelWidth={"35%"}
                    inputWidth={"55%"}
                    textAlign={"right"}
                    paddingRight={"5px"}
     ...
     <InputField
                  ...
                  />
     <InputField
                    label={"Fair Market Value On Date Of Death :"}
                    labelWidth={"35%"}
                    inputWidth={"55%"}
                    textAlign={"right"}
                    paddingRight={"5px"}
      ...
      <InputField
                  ...
                  />
     <InputField
                    label={"Cancel Post Split Zero Shares :"}
                    labelWidth={"35%"}
                    inputWidth={"55%"}
                    textAlign={"right"}
                    paddingRight={"5px"}
     ...
     <InputField
       ...
       <InputField
                  ...
                  />   
     <InputField
                    label={"Total No. of Shareholders :"}
                    labelWidth={"35%"}
                    inputWidth={"55%"}
                    textAlign={"right"}
                    paddingRight={"5px"}
