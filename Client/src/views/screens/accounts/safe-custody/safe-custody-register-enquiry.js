...
import SafeCustodyRegisterEnquiry2 from "./components/safe-custody-register-enquiry-modal";
...
const SafeCustodyRegisterEnquiry = () => {
  const [myObj, setMyObj] = useState({ acct_link: "", account_name: "" });
  ...
  const fetchData = async () => {
    ...
    await axios
      .post(
        API_SERVER + "/api/safe-custody-register-enquiry",
        {
          fetch_data: "true",
            ...
            >
              ...
              <div style={{ flex: 0.4 }}>
                <InputField
                  ...
                  inputWidth={"70%"}
                  onChange={(e) =>
                    handleChange("account_name", e.target.value?.toUpperCase())
                  }
