          ...
          <div
              ...
              >
                ...
                <div  style={{
                  ...
                  >
                  ACH/ACP Inward Rejection Approval
                  </header> 
                  &nbsp;
                  <DataTable
                  columns={["Entry Date", "Batch ID", "Ref.No", "Amount", "Drawer Account", "Drawer", "Beneficiary Name", "Receiving Bank", "Rejection Reason", "View"]}
                  />
          </div>
        </div>
      );
}
export default ACHACPREJECTION;