          ...
          <div
              ...
              >
                ...
                <div  style={{
                  ...
                  >
                  Direct Credit Rejection Cancellation
                  </header> 
                  &nbsp;
                  <DataTable
                  columns={["Entry Date", "Batch ID", "Reference.No", "Amount","Drawer", "Beneficiary Name", "Receiving Bank", "Reject Reason", "Value Date", "ACH/ACP View"]}
                  />
          </div>
        </div>
      );
}
export default RejectionCANACHP;