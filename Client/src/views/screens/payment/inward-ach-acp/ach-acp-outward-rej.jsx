          ...
          <div
              ...
              >
                ...
                <div  style={{
                  ...
                  >
                  ACH/ACP Outward Rejection Approval
                  </header> 
                  &nbsp;
                  <DataTable
                  columns={["Entry Date", "Batch ID", "Reference.No", "Amount", "Drawer", "Beneficiary Name", "Receiving Bank", "Rejection Reason", "Value Date", "ACH/ACP", "View"]}
                  />
          </div>
        </div>
      );
}
export default ACHPOUTWARDREJ;