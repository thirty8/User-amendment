      ...
      <div className="border rounded">
        <div className="md:flex justify-center w-full">
          {/* **************************************** */}
            ...
            {/* Source Of Wealth */}
            <div className='border md:p-1 text-white md:mt-1 bg-gray-400' 
                style={{
                background:'',
                }}
            >
            ...
            {/* <DataTable columns={columns_} data={rows_} rowsPerPage={2} /> */}
                ...
                <table className="w-full" style={{zoom:0.70}}>
                  <thead className="bg-sky-700">
                    <tr>
                      ...
                      <th style={{borderRight:'1px solid white'}} className="text-white font-bold px-4 py-2">Wealth Value</th>
                    </tr>
                  </thead>
                  <tbody>
                    {sourceOfWealth.map((item, index) => (
                      <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-200'}>
                        ...
                        <td className="border px-4 py-2 text-center">{item[2]}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className='border md:p-1 text-white md:mt-3 bg-gray-400'
                style={{
                    background:'',
                    }}
                >
          ...
          <div className="w-full max-w-2xl">
                ...
                <div className='border md:p-1 text-white bg-gray-400 ' 
                style={{
                background:'',
                }} 
            ...
            <div 
              className=" p-1 mt-[23px] text-white bg-gray-400"
            >
                  Other Details
            </div>
            ...
            <div class="w-full max-w-xl mt-2">
              <div class="md:flex md:items-center mb-2 ml-2">
                  ...
                  <div class="md:w-2/3 md:ml-[2px]">
                    <InputField 
                      inputWidth={'75%'}
                      name="p_no_withdrawal_month"
                      value={anti_money.p_no_withdrawal_month}
                      onChange={handleChangeAntiMoney}
                    />
              ...
              <div class="md:flex md:items-center mb-2 ml-2">
                  ...
                  <div class="md:w-2/3 md:ml-[2px]">
                    <InputField 
                      ...
                      inputWidth={'75%'}
                      name="p_amt_withdrawal_month"
                      value={anti_money.p_amt_withdrawal_month}
                      onChange={handleChangeAntiMoney}
                    />
                  </div>
              </div>
            ...
            <div class="w-full max-w-xl mt-2">
              <div class="md:flex md:items-center mb-2 ml-2">
                  ...
                  <div class="md:w-2/3 md:ml-[2px]">
                    <InputField 
                      inputWidth={'75%'}
                      name="p_no_deposit_month"
                      value={anti_money.p_no_deposit_month}
                      onChange={handleChangeAntiMoney}
                    />
                  </div>
              </div>
            ...
            <div class="w-full max-w-xl mt-2">
              <div class="md:flex md:items-center mb-2 ml-2">
                  ...
                  <div class="md:w-2/3 md:ml-[2px]">
                    <InputField 
                      inputWidth={'75%'}
                      name="p_amt_deposit_month"
                      value={anti_money.p_amt_deposit_month}
                      onChange={handleChangeAntiMoney}
                    />
                  </div>
              </div>
