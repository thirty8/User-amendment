...
const Address = ({
  ...
  const [passAddressData, setPassAddressData] = useState("");

  // Function to handle editing an existing address
  const handleEditAddress = (index) => {
    console.log("address:", index);
    setPassAddressData(index);
          ...
          <tbody>
            {addressData?.length > 0 ? (
              addressData?.map((address, index) => (
                <tr key={index}>
                  <td>{address.RELATION_NO}</td>
                  <td>{address.ADDRESS_ID}</td>

                  <td>{address.LOCATION}</td>
                  <td>{address.PHONE1}</td>
                  <td>{address.PH_ADDRESS2}</td>
                  ...
                  <div class="md:flex md:items-center mb-2 ml-2">
                    ...
                    <div className="md:w-2/3 ">
                      <ListOfValue
                        ...
                        inputWidth="300px"
                        value={
                          passAddressData ? passAddressData?.ADDRESS_TYPE : ""
                        }
                        onChange={(value) =>
                  ...
                  <div class="md:flex md:items-center mb-2 ml-2">
                    ...
                    <div class="md:w-2/3 md:ml-[2px] ">
                      <InputField
                        inputWidth="300px"
                        name="PH_ADDRESS2"
                        value={passAddressData?.PH_ADDRESS2}
                        onChange={(e) =>
                  ...
                  <div class="md:flex md:items-center mb-2 ml-2">
                    ...
                    <div class="md:w-2/3 md:ml-[2px] ">
                      <InputField
                        inputWidth="300px"
                        name="PH_ADDRESS3"
                        value={passAddressData?.LOCATION}
                        onChange={(e) =>
                  ...
                  <div class="md:flex md:items-center mb-2 ml-2">
                    ...
                    <div className="md:w-2/3 ">
                      <ListOfValue
                        inputWidth="300px"
                        data={country}
                        value={passAddressData?.COUNTRY_CODE}
