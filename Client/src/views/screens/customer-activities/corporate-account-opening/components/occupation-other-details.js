            ...
            <div class="md:w-2/3 md:ml-[2px]">
              <div className="">
                ...
                <InputField
                  ...
                  name="NATIONAL_ID_V"
                  value={
                    add_new_relation.NATIONAL_ID_V ?? saveDataNewForm.nationalID
                  }
          ...
          <div class="md:flex md:items-center mb-2 ml-2">
            ...
            <DatePicker
                ...
                onChange={(date) =>
                  setAddNewRelation({
                    ...add_new_relation,
                    NIN_dateissued_v: formatDate(date.toISOString(), false),
                  })
                }
              ...
              {/* <DatePicker
                ...
                onChange={(date) => {
                  ...
                  setAddNewRelation({
                    ...add_new_relation,
                    NIN_dateissued_v: formattedDate,
                  });
                }}
                className="w-[150px] px-2 border border-gray-300 text-left rounded focus:outline-none"
                dateFormat="dd-MM-yyyy"
            ...
            <div class="md:w-2/3 md:ml-[30px]">
              <DatePicker
                ...
                onChange={(date) => {
                  ...
                  setAddNewRelation({
                    ...add_new_relation,
                    ID_date_issued_v: formattedDate,
                  });
                }}
                className="w-[150px] px-2 border border-gray-300 text-left rounded focus:outline-none"
                dateFormat="dd-MM-yyyy"
