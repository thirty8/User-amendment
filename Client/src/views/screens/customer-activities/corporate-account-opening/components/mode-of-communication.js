...
function Mode_Of_Communication({
  saveDataNewForm,
  errors,
  data,
  validationRules,
  ...
  return (
    <div>
        ...
        <div>
          <label className="flex items-center">
            <input
              type="checkbox"
              name="P_SMS_ALERT"
              checked={add_new_relation.P_SMS_ALERT === "Y"}
        ...
        <div>
          <label className="flex items-center">
            <input
              type="checkbox"
              name="P_EMAIL_ALERT"
              checked={add_new_relation.P_EMAIL_ALERT === "Y"}
              onChange={handleCheckboxChange}
              className="mr-2"
            />
            Email Alert
        ...
        <div>
          <label className="flex items-center">
            <input
              type="checkbox"
              name="P_E_STATEMENT"
              checked={add_new_relation.P_E_STATEMENT === "Y"}
              onChange={handleCheckboxChange}
              className="mr-2"
            />
            E-Statement
        ...
        <div>
          <label className="flex items-center">
            <input
              ...
              checked={add_new_relation.P_INTERNET_BANKING === "Y"}
              onChange={handleCheckboxChange}
              className="mr-2"
            />
            Internet Banking
        ...
        <div>
          <label className="flex items-center">
            <input
              ...
              checked={add_new_relation.P_MOBILE_BANKING === "Y"}
              onChange={handleCheckboxChange}
              className="mr-2"
            />
            Mobile Banking
        ...
        <div>
          <label className="flex items-center">
            <input
              type="checkbox"
              name="P_ATM_SERVICES"
              checked={add_new_relation.P_ATM_SERVICES === "Y"}
              onChange={handleCheckboxChange}
              className="mr-2"
            />
            ATM Services
      ...
      <div className="grid grid-cols-2 gap-6 mt-2">
        {/* ATM Services */}
        {add_new_relation.P_ATM_SERVICES === "Y" && (
  <div className="border border-gray-300 p-4">
    ...
    <table className="w-full border border-gray-300">
      ...
      <tbody>
        ...
        {/* {add_new_relation.P_ATM_SERVICES == "Y" && (
          <div className="border border-gray-300 p-4">
            ...
            <table className="w-full border border-gray-300">
              ...
              <tbody>
                {Object.keys(atmServiceOptions).map((key) => (
                  <tr key={key}>
                    <td className="border-b px-4 py-2">
                    ...
                    <td className="border-b px-4 py-2 text-center">
                      <input
                        type="checkbox"
                        name={key}
                        checked={atmServiceOptions[key]}
                        onChange={handleAtmServiceOptionsChange}
                        className="mx-auto"
                      />
                    </td>
                  </tr>
        ...
        {add_new_relation.P_E_STATEMENT === "Y" && (
          <div className="border border-gray-300 p-4">
            ...
            <table className="w-full border border-gray-300">
              ...
              <tbody>
                    ...
                    <Group direction="column" spacing="xs">
                      {frequencyOptions.map((option) => (
                        <Radio
                          ...
                          value={option.value}
                          checked={
                            add_new_relation.P_SERVICE_CODE === option.value
                          }
                ...
                <tr>
                  ...
                  <td className="border-b px-4 py-2">
                    <DatePicker
                      // selected={add_new_relation.P_STATE_DATE}
                      selected={add_new_relation.P_STATE_DATE ? new Date(add_new_relation.P_STATE_DATE) : null}
                ...
                <tr>
                  ...
                  <td className="border-b px-4 py-2">
                    <DatePicker
                    selected={add_new_relation.P_END_DATE ? new Date(add_new_relation.P_END_DATE) : null}
                      // selected={add_new_relation.P_END_DATE}
