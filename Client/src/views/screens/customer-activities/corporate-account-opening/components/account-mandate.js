  ...
  return (
    <div>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
              {storedFormData.map((data, index) => (
                <tr key={index} className={index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-300'}>
                  <td className="text-center">{randomNumberString}</td>
                  <td>{data.P_fname}</td>
                  <td>{data.P_mname}</td>
                  <td>{data.P_sname}</td>
                  <td>{data.P_dob}</td>
      ...
      <div className='flex justify-end cursor-pointer'>
              ...
              <tbody>
                {dataD.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="text-center border w-50 py-1">
                      <div className="flex -space-x-5">
                        ...
                        />
                        <div
                          className="border border-gray-50 px-1 rounded-md bg-sky-700 text-white cursor-pointer shadow-md"
                          onClick={openModal}
                        >
                          View&nbsp;Docs
                        </div>
                    ...
                    <td className="text-center border w-10 py-1">
                      <InputField
                        type="date"
                        onChange={(e) => handleChangeDocs(e, index, "b")}
                      />
                    </td>
        ...
        >
          <div>
            <DocumentViewing documentID={docsId} />
          </div>
