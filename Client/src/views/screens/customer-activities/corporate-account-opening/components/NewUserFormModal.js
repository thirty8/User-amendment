...
const NewUserFormModal = ({ isOpen, onClose, formData, setFormData, handleFormSubmit }) => (
  <Modal
    opened={isOpen}
    onClose={onClose}
    size="100%"
  ...
  >
    <div style={{ padding: '16px' }}>
      {/* Add input fields for capturing new user information */}
      <TextInput
        size="xs"
        label="Full Name"
...
//       {!onclickOnrow ? (
//         <div
//           className={`flex justify-end mr-2 mb-2 mt-2 ${
