...
function Individual_account_opening({
  data,
  validationRules,
  formValues,
  setFormValues,
  ...
  const handleSubmit = (event) => {
    ...
    axios.get(API_SERVER + "/api/get-unique-ref", { headers }).then((response) => {
          ...
          >
            ...
            <div className="w-full max-w-2xl">
              ...
              <div class="w-full max-w-xl mt-2">
                <div class="md:flex md:items-center mb-2 ml-2">
                  <div class="md:w-1/3">
                    <Label label="Primary Phone Number" required={true} />
                  </div>
                  <div class="md:w-2/3 ">
                    <input
                      className="risk_label"
            ...
            <div className="w-full max-w-2xl">
              ...
              <div class="w-full max-w-xl mt-2">
                <div class="md:flex md:items-center mb-2 ml-2">
                  <div class="md:w-1/3">
                    <Label label="ID Expiry Date" required={true} />
                  </div>
                  <div class="md:w-2/3 ">
                    <input
                      className="risk_label"
