...
function GovSalaryUploadWithFees(){
    ...
    return(
        ...
        <div className="w-[100%]">
          ...
          />
                    ...
                    {/* Fees */}
                    <div style={{display:"flex", flex:1,marginTop: "10px"}} className="space-x-2 ml-2 mr-2">
                    <div style={{width: "100%",}} className="h-auto  pb-2 pt-2 px-2 mb-16 wrapper rounded border-2"> 
                    <div className="w-full">
                    <header
          className="text-white text-base py-1 rounded-t font-semibold px-2 uppercase"
          style={{
        ...
        &nbsp;
        <div className="flex w-[100%] mb-2 space-x-2">
          <div className="w-[100%]">
            <InputField 
...
export default GovSalaryUploadWithFees;