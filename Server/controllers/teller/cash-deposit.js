...
let cashDepositFunc = async (
  ...
  try {
    ...
    if (db) {
      ...
      //   return data;
      const sql = `BEGIN Pkg_cashtrx_rt.prc_actrxcash_rt (:acct, :amt, :v_date, 'BRA', :trans_desc, 'CDLY', :p_by, :app_by, :terminal, :branch, 'CDP', NULL, :btch, :DOCUMENT_REFF, 'Y', :narration, :TRANS_REF, :SRC_FUND, :FORM_COD, :resp_code, :resp_mess); END;`;
      const bindVars = {
        acct: account_number,
        amt: amount,
