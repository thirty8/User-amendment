...
const ChequeBookMaintenanceApproval = async (req, res) => {
  const {
    acct_link,
    // host_name_v,
    batch_number,
  ...
  try {
    ...
    if (handle_procedure === "true") {
      const result = await con.execute(
        `begin PKG_CHEQUE_BOOK.prc_chequebk_maintenance_app(:prc_type_v,:acct_link, :global_bra_v, :global_username,
...
module.exports = { ChequeBookMaintenanceApproval };
