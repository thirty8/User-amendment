...
let loginFunc = async(username, password) => {
    try {
        ...
        if (db) {
            let response;
            result = execute(
                "BEGIN prc_userlogin_process_react(:vusername, :vpassword, :global_hostname, :global_machineip, :login_code, :mess, :PD, :BR_DESC, :FNAME, :EMAIL, :LANG, :USERID,:BRACODE,:AUTH_CODE,:ACCESS_CODES); END;", {
                    vusername: {
